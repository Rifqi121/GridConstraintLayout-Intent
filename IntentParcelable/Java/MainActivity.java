package com.example.intentparcelabel;
    ...
    public  void  onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Rifqi Fauzan Adzikra");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 24);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Rifqi Fauzan Adzikra");
                mPerson.setAge(17);
                mPerson.setEmail("rifqifauzanadziqra1@gmail.com");
